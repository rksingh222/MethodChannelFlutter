...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> getBatteryInformation() async{
    String batteyPercentage;
    try{
      var result = await batteryChannel.invokeMethod('getBatteryLevel');
      batteyPercentage = 'battery level at $result%';
    } on PlatformException catch(e){
      batteyPercentage = 'failed to get battery level ${e.message}';
    }
    setState(() {
      _batteryPercentage = batteyPercentage;
    });
        ...
        children: [
          MaterialButton(onPressed: () async{
            ...
            child: Padding(
              ...
              child: Text('click me',style: TextStyle(color: Colors.white,fontSize: 35.0,),),
            ),
          ),
